...
To include remote PR evidence explicitly, add `selection.prUrls` to a work-context request. See [PR evidence dossiers](work-evidence.md) for confirmed-link requirements, SHA consistency, partial sources and privacy boundaries.
