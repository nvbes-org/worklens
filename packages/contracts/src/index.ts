...
export type WorkContextSelection = { sections: Array<WorkContextSection>, projectIds: Array<string>, agentIds: Array<string>, worktreePaths: Array<string>, documentPaths: Array<string>, noteIds: Array<string>, prUrls: Array<string>, };
